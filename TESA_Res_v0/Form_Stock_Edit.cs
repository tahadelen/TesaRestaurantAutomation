...
namespace TESA_Res_v0
{
    ...
    {
        private Button btn_edit_stock = new Button();
        ...
        protected override void btn_jobless_Click(object sender, EventArgs e)
        {
            ...
            //DataRow row = (dg_stocks.SelectedRows[0].DataBoundItem as DataRowView).Row;
            //int iId = int.Parse(row.ItemArray[0].ToString());
